<div class="main_cont">
	<div class="nav1">
		...
		<div class="mobile_btn"><a href="#" onclick='menu_open();'>&#9776;</a></div>
	</div>
	...
	<div class="nav2">
		...
		<a href="dashboard.php" onclick='menu_close();'>Dashboard</a>
		<a href="profile.php" onclick='menu_close();'>Profile</a>
		<a href="#" onclick='menu_close();'>Contact</a>
		<div class="mobile_1200 mobile_reg">
			<?php
				...
				if(isset($_SESSION['u_id'])){
					...
					<div class='mob_log'><div class='mob_log1' onclick='menu_close();'> <form action='logout_inc.php' method='post'><input type='submit' name='submit_logout' value='logout'></form></div></div>";
				}else{
